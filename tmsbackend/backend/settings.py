...
SECRET_KEY = 'django-insecure-o($scr(i^=80vzhu!pblfsl5&*g^ug6i=ln&2^2_0$kc64ry&q'
...
REST_FRAMEWORK = {
    'DEFAULT_AUTHENTICATION_CLASSES': (
        ...
        'students.auth.StudentAuthentication',
        'mentors.auth.MentorAuthentication',
    ),
...
AUTHENTICATION_BACKENDS = [
    'backend.authenticate.StudentsBackend',
    'backend.authenticate.MentorsBackend',
